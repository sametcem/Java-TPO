 ...
 * 
 */
@WebServiceClient(name = "CalculatorImplService", targetNamespace = "http://ws.ecodeup.com/", wsdlLocation = "http://localhost:1515/WS/Calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORIMPLSERVICE_QNAME = new QName("http://ws.ecodeup.com/", "CalculatorImplService");
    ...
    public Calculator getCalculatorImplPort() {
        return super.getPort(new QName("http://ws.ecodeup.com/", "CalculatorImplPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ws.ecodeup.com/", "CalculatorImplPort"), Calculator.class, features);
    }
